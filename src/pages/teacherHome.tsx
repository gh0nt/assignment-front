...
import TeacherEvaluations from '@/components/teacher/Projects/Projects.component'
      ...
      <div className="tw-min-h-full">
        ...
        <header className="tw-bg-white tw-shadow">
          <div className="tw-mx-auto tw-max-w-7xl tw-px-4 tw-py-6 sm:tw-px-6 lg:tw-px-8">
            <h1 className="tw-text-3xl tw-font-bold tw-tracking-tight tw-text-gray-900">Panel de Docente</h1>
          </div>
        </header>
        <main>
          <div className="tw-mx-auto tw-max-w-7xl tw-px-4 tw-py-6 sm:tw-px-6 lg:tw-px-8">
